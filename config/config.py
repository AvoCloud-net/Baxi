...
class Icons:
    ...
    # MC ↔ Discord event-bridge emojis (DiscordGate)
    enter              = "<:enter:1498815876068278363>"    # 📥 join
    leave              = "<:exit:1498816313940770988>"    # 📤 quit (same id for now)
    skull              = "<:skull:1498816933561368857>"    # 💀 death
